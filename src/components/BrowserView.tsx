          ...
          {error && (
            <div className="absolute top-6 left-1/2 -translate-x-1/2 bg-white border border-red-200 text-gray-800 px-4 py-3 rounded-lg shadow-xl z-20 flex items-start gap-3 max-w-lg">
              ...
              <div>
                ...
                <p className="text-[10px] mt-2 text-gray-500 font-mono">Nota: O ambiente de preview pode não suportar dependências do Chromium. Use os arquivos Dockerfile/docker-compose fornecidos para executar localmente.</p>
              </div>
            </div>
          )}
